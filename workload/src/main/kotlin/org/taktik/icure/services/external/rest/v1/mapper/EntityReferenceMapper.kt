...
@Mapper(componentModel = "spring", uses = [ CodeStubMapper::class, IdentifierMapper::class, PropertyTypeStubMapper::class ], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
