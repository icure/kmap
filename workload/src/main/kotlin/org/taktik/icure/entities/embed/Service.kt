...
data class Service(
       override val id: String = UUID.randomUUID().toString(),
        ...
        val subContactIds: Set<String>? = null, //Only used when the Service is emitted outside of its contact
        val plansOfActionIds: Set<String>? = null, //Only used when the Service is emitted outside of its contact
        val healthElementsIds: Set<String>? = null, //Only used when the Service is emitted outside of its contact
        val formIds: Set<String>? = null, //Only used when the Service is emitted outside of its contact
        val secretForeignKeys: Set<String>? = emptySet(), //Only used when the Service is emitted outside of its contact
        val cryptedForeignKeys: Map<String, Set<Delegation>> = emptyMap(), //Only used when the Service is emitted outside of its contact
        val delegations: Map<String, Set<Delegation>> = emptyMap(), //Only used when the Service is emitted outside of its contact
        val encryptionKeys: Map<String, Set<Delegation>> = emptyMap(), //Only used when the Service is emitted outside of its contact
        val contactId: String? = null, //Only used when the Service is emitted outside of its contact
        ...
        override val codes: Set<CodeStub> = emptySet(), //stub object of the Code used to qualify the content of the Service
        override val tags: Set<CodeStub> = emptySet(), //stub object of the tag used to qualify the type of the Service
